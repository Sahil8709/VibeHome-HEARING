  ...
  <div>
    ...
    <span className="block text-teal-400 text-sm font-bold tracking-widest mt-0.5">HEARING & SPEECH</span>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: 'Hearing Loss', path: '/hearing-loss' },
                { label: 'Speech & Swallow Therapy', path: '/speech-therapy' },
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                { label: 'Free Hearing Test', path: '/contact' },
                { label: 'Home Visit Service', path: '/contact' },
                { label: 'Hearing Aid Trial & Fitting', path: '/hearing-aids' },
                { label: 'Speech Assessment', path: '/speech-therapy' },
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-400">Hyderabad & across India – Home visits available</span>
              </li>
            </ul>
            <div className="mt-6">
              <Link to="/contact"
                className="inline-block bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold px-5 py-2.5 rounded-xl transition-colors">
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-500">© 2025 VibeHome Hearing & Speech. All rights reserved.</p>
          <p className="text-xs text-gray-500">Designed with care for better hearing and speech health</p>
        </div>
      </div>
    </footer>
  )
