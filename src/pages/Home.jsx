...
const services = [
  ...
  },
  {
    ...
    desc: 'Our experts come to your doorstep. No travel needed — ideal for elderly patients.',
  ...
  },
  {
    ...
    desc: 'Precise fitting and programming of hearing aids tailored to your unique hearing profile.',
...
const brands = [
  ...
  { name: 'Starkey', color: 'from-green-500 to-green-700' },
  { name: 'Oticon', color: 'from-orange-500 to-orange-700' },
]

const products = [
  { name: 'BTE Hearing Aid', type: 'Behind the Ear', price: '₹15,000', badge: 'Most Popular', color: 'bg-blue-600' },
  { name: 'RIC Hearing Aid', type: 'Receiver in Canal', price: '₹22,000', badge: 'Best Fit', color: 'bg-teal-600' },
  { name: 'ITE Hearing Aid', type: 'In the Ear', price: '₹28,000', badge: 'Discreet', color: 'bg-purple-600' },
  { name: 'CIC Hearing Aid', type: 'Completely in Canal', price: '₹35,000', badge: 'Invisible', color: 'bg-indigo-600' },
]
...
const faqs = [
  {
    ...
    a: 'Yes, completely free with no hidden charges. Our certified audiologist visits your home or you can visit our clinic — no obligation to purchase.',
  },
  {
    q: 'How long does a hearing test take?',
    a: 'A complete hearing evaluation takes about 30–45 minutes. We test both ears, check speech clarity, and provide a detailed audiogram.',
  },
  {
    q: 'Do you offer home visits for elderly patients?',
    a: 'Absolutely. Home visits are our specialty. We bring all equipment to your home so elderly or mobility-challenged patients get tested in comfort.',
  },
  {
    q: 'Which hearing aid brands do you carry?',
    a: 'We carry all major brands including Signia, Phonak, Resound, Widex, Starkey, and Oticon — across all price ranges from budget to premium.',
  },
  {
    q: 'What is the price range of hearing aids?',
    a: 'Hearing aids start from ₹8,000 and go up to ₹2,50,000 depending on the brand, technology level, and style. We have options for every budget.',
  },
  {
    q: 'Is there a warranty on hearing aids?',
    a: 'Yes. All hearing aids come with a manufacturer warranty of 1–3 years. We also provide lifetime service support and free follow-up visits.',
  },
]
    ...
    <div className="pt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block bg-teal-500/20 text-teal-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-teal-400/30">
                🎧 India's Trusted Hearing Care
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
                Better Hearing
                <span className="block text-teal-300">Starts at Home</span>
              </h1>
              <p className="text-lg text-blue-100 mb-8 max-w-lg leading-relaxed">
                Professional hearing tests and premium hearing aids delivered to your doorstep. Trusted by over 10,000 families across India.
              </p>
              ...
              <div className="flex gap-8 mt-10">
                {[['10,000+', 'Happy Patients'], ['15+', 'Years Experience'], ['6', 'Premium Brands']].map(([num, label]) => (
                  <div key={label}>
            ...
            <div className="hidden lg:flex items-center justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 p-8">
                  ...
                  <p className="text-center text-white font-semibold text-lg">Professional Hearing Care</p>
                  <p className="text-center text-blue-200 text-sm">At your doorstep, on your schedule</p>
                  <div className="flex gap-2 flex-wrap justify-center">
                    {['Free Test', 'Home Visit', 'Expert Fitting'].map(tag => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">Complete hearing care from diagnosis to aftercare — all from the comfort of your home.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((s) => (
              <div key={s.title} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 border border-gray-100">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { step: '01', title: 'Book Online', desc: 'Fill the form or WhatsApp us to schedule your free hearing test.' },
              { step: '02', title: 'Home Visit', desc: 'Our audiologist visits your home with professional equipment.' },
              { step: '03', title: 'Get Tested', desc: 'Complete hearing evaluation and audiogram in 30–45 minutes.' },
              { step: '04', title: 'Get Fitted', desc: 'Choose your hearing aid and get it fitted and programmed same day.' },
            ].map((item, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((p) => (
              <div key={p.name} className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
                <div className={`${p.color} h-44 flex items-center justify-center relative`}>
      ...
      <section className="py-20 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-3xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 sm:p-10 border border-white/20 text-center">
              ...
              <div className="flex gap-2">
                {testimonials.map((_, i) => (
                  <button key={i} onClick={() => setTestimonialIndex(i)}
                    className={`w-2.5 h-2.5 rounded-full transition-all duration-200 ${i === testimonialIndex ? 'bg-teal-400 w-6' : 'bg-white/30'}`}
                  />
                ))}
              </div>
      ...
      <section className="py-16 bg-gradient-to-r from-teal-600 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">Ready to Hear Better?</h2>
          <p className="text-teal-100 text-lg mb-8 max-w-xl mx-auto">
            Book your free hearing test today. Our expert will come to you — no travel, no hassle.
          </p>
